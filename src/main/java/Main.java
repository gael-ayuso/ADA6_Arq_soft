...
public class Main {
    public static void main(String[] args) {
        ...
        // Para alternar entre persistencia en memoria y archivo (Segunda parte de ADA6),
        // unicamente se cambia la instanciacion aqui:
        // =========================================================================
        ...
        // Puede iniciarse en modo grafico (GUI con FlatLaf) o consola interactiva.
        // =========================================================================
        PedidoVista vista;
